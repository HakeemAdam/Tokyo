...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd ? define(factory) : (global.React = factory());
})(this, function() {
  'use strict';
...
*/
  ...
  var objectAssign$1 = shouldUseNative()
    ? Object.assign
 ...
 */
  function isValidElement(object) {
    return (
      typeof object === 'object' && object !== null && object.$$typeof === REACT_ELEMENT_TYPE$1
    );
  }
 ...
 */
  function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
    ...
    if (Array.isArray(children)) {
      ...
      var iteratorFn =
        (ITERATOR_SYMBOL && children[ITERATOR_SYMBOL]) || children[FAUX_ITERATOR_SYMBOL];
 ...
 */
  function validateChildKeys(node, parentType) {
    ...
    if (Array.isArray(node)) {
      ...
      var iteratorFn =
        (ITERATOR_SYMBOL$1 && node[ITERATOR_SYMBOL$1]) || node[FAUX_ITERATOR_SYMBOL$1];
      if (typeof iteratorFn === 'function') {
 ...
 */
  function validateFragmentProps(fragment) {
    ...
    try {
      for (
        var _iterator = Object.keys(fragment.props)[Symbol.iterator](), _step;
